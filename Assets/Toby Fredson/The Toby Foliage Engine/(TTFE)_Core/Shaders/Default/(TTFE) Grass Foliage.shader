	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float3 temp_output_696_0_g2152 = ( input.positionOS.xyz * 0.3 );
				...
				float3 worldToObjDir731_g2152 = mul( GetWorldToObjectMatrix(), float4( ( ( (simpleNoise678_g2152*3.09 + -1.5) * 1.6 ) * temp_output_683_0_g2152 * ( temp_output_683_0_g2152 * ( temp_output_696_0_g2152 - rotatedValue695_g2152 ) ) * sin( _TimeParameters.x * 0.125 ) * input.positionOS.xyz.y ), 0 ) ).xyz;
				...
				float3 rotatedValue711_g2152 = RotateAroundAxis( ( saturate( input.positionOS.xyz.y ) * input.positionOS.xyz ), ( cos( ( ( ase_worldPos * 0.2 ) + mulTime702_g2152 ) ) * input.positionOS.xyz.y * float3(0.5,0.05,0.5) ), NormaliseRotationAxis218_g2152, NoiseLarge101_g2152 );
				...
				float3 temp_output_725_0_g2152 = ( input.positionOS.xyz * 0.2 );
				float3 rotatedValue727_g2152 = RotateAroundAxis( float3( 0,0,0 ), temp_output_725_0_g2152, NormaliseRotationAxis218_g2152, ( ( NoiseLarge101_g2152 * StrongWindSpeed921_g2152 ) * input.positionOS.xyz.y * Scale_MaskC216_g2152 * Scale_MaskB112_g2152 ).x );
				...
				float3 staticSwitch1011_g2152 = (float3( 0,0,0 ) + (( ( worldToObjDir731_g2152 - ( worldToObjDir715_g2152 * input.positionOS.xyz.y * Scale_MaskA177_g2152 * MaskRotation268_g2152 * Scale_MaskC216_g2152 ) ) + staticSwitch735_g2152 ) - float3( 0,0,0 )) * (float3( 1,1,1 ) - float3( 0,0,0 )) / (float3( 1,1,1 ) - float3( 0,0,0 )));
				...
				float3 LightDetectBackface_Output156_g2153 = float3(0,1,0);
				...
				float3 vertexValue = FinalWind_Output350_g2152;
					...
					input.positionOS.xyz += vertexValue;
				#endif
				input.normalOS = LightDetectBackface_Output156_g2153;
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_AlbedoMap285_g2153 = input.ase_texcoord9.xy;
				float2 uv_AlbedoMap295_g2153 = input.ase_texcoord9.xy;
				float4 tex2DNode295_g2153 = tex2D( _AlbedoMap, uv_AlbedoMap295_g2153 );
				float2 uv_NoiseMapGrayscale302_g2153 = input.ase_texcoord9.xy;
				float4 transform307_g2153 = mul(GetObjectToWorldMatrix(),float4( 1,1,1,1 ));
				float dotResult4_g2155 = dot( transform307_g2153.xy , float2( 12.9898,78.233 ) );
				float lerpResult10_g2155 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g2155 ) * 43758.55 ) ));
				float3 normalizeResult259_g2153 = normalize( input.ase_texcoord10.xyz );
				float DryLeafPositionMask263_g2153 = ( (distance( normalizeResult259_g2153 , float3( 0,0.8,0 ) )*1.0 + 0.0) * 1 );
				float4 lerpResult294_g2153 = lerp( ( _DryLeafColor * ( tex2DNode295_g2153.g * 2 ) ) , tex2DNode295_g2153 , saturate( (( ( tex2D( _NoiseMapGrayscale, uv_NoiseMapGrayscale302_g2153 ).r * lerpResult10_g2155 * DryLeafPositionMask263_g2153 ) - _SeasonChangeGlobal )*_DryLeavesScale + _DryLeavesOffset) ));
				float4 SeasonControl_Output311_g2153 = lerpResult294_g2153;
				Gradient gradient271_g2153 = NewGradient( 0, 2, 2, float4( 1, 0.276868, 0, 0 ), float4( 0, 1, 0.7818019, 1 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float4 transform273_g2153 = mul(GetObjectToWorldMatrix(),float4( 1,1,1,1 ));
				float dotResult4_g2154 = dot( transform273_g2153.xy , float2( 12.9898,78.233 ) );
				float lerpResult10_g2154 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g2154 ) * 43758.55 ) ));
				float4 lerpResult282_g2153 = lerp( SeasonControl_Output311_g2153 , ( ( SeasonControl_Output311_g2153 * 0.5 ) + ( SampleGradient( gradient271_g2153, lerpResult10_g2154 ) * SeasonControl_Output311_g2153 ) ) , _ColorVariation);
				float2 uv_MaskMapRGBA313_g2153 = input.ase_texcoord9.xy;
				float4 lerpResult283_g2153 = lerp( tex2D( _AlbedoMap, uv_AlbedoMap285_g2153 ) , lerpResult282_g2153 , (( _BranchMaskR )?( tex2D( _MaskMapRGBA, uv_MaskMapRGBA313_g2153 ).r ):( 1.0 )));
				float4 GrassColorVariation_Output109_g2153 = lerpResult283_g2153;
				float3 ase_viewVectorWS = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				float3 ase_viewDirWS = normalize( ase_viewVectorWS );
				float4 transform39_g2153 = mul(GetObjectToWorldMatrix(),float4( input.ase_texcoord10.xyz , 0.0 ));
				float dotResult52_g2153 = dot( float4( ase_viewDirWS , 0.0 ) , -( float4( _MainLightPosition.xyz , 0.0 ) + ( (( _TranslucencyFluffiness )?( transform39_g2153 ):( float4( input.ase_texcoord10.xyz , 0.0 ) )) * _TranslucencyRange ) ) );
				float2 uv_MaskMapRGBA58_g2153 = input.ase_texcoord9.xy;
				float ase_lightIntensity = max( max( _MainLightColor.r, _MainLightColor.g ), _MainLightColor.b );
				float4 ase_lightColor = float4( _MainLightColor.rgb / ase_lightIntensity, ase_lightIntensity );
				float TobyTranslucency66_g2153 = ( saturate( dotResult52_g2153 ) * tex2D( _MaskMapRGBA, uv_MaskMapRGBA58_g2153 ).b * ase_lightColor.a );
				float TranslucencyIntensity72_g2153 = _TranslucencyPower;
				float4 Albedo_Output160_g2153 = ( ( _AlbedoColor * GrassColorVariation_Output109_g2153 ) * (1.0 + (TobyTranslucency66_g2153 - 0.0) * (TranslucencyIntensity72_g2153 - 1.0) / (1.0 - 0.0)) );
				
				float2 uv_NormalMap189_g2153 = input.ase_texcoord9.xy;
				float3 unpack189_g2153 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap189_g2153 ), _NormalIntensity );
				unpack189_g2153.z = lerp( 1, unpack189_g2153.z, saturate(_NormalIntensity) );
				float3 Normal_Output154_g2153 = unpack189_g2153;
				
				float temp_output_349_0_g2153 = ( 0.2 * _SpecularPower );
				float2 uv_SpecularMapGrayscale251_g2153 = input.ase_texcoord9.xy;
				float fresnelNdotV373_g2153 = dot( WorldTangent, _MainLightPosition.xyz );
				float fresnelNode373_g2153 = ( _SpecularBias + _SpecularScale * pow( max( 1.0 - fresnelNdotV373_g2153 , 0.0001 ), _SpecularStrength ) );
				float SpecRecalculate368_g2153 = saturate( fresnelNode373_g2153 );
				#ifdef _SPECULARBACKFACEOCCLUSION_ON
				float staticSwitch340_g2153 = ( temp_output_349_0_g2153 * saturate( (tex2D( _SpecularMapGrayscale, uv_SpecularMapGrayscale251_g2153 ).r*_SpecularMapScale + _SpecularMapOffset) ) * SpecRecalculate368_g2153 );
				#else
				float staticSwitch340_g2153 = temp_output_349_0_g2153;
				#endif
				float Specular_Output158_g2153 = staticSwitch340_g2153;
				float3 temp_cast_7 = (Specular_Output158_g2153).xxx;
				
				float2 uv_MaskMapRGBA89_g2153 = input.ase_texcoord9.xy;
				float4 tex2DNode89_g2153 = tex2D( _MaskMapRGBA, uv_MaskMapRGBA89_g2153 );
				float Smoothness_Output159_g2153 = ( tex2DNode89_g2153.a * _SmoothnessIntensity );
				
				float AoMapBase103_g2153 = tex2DNode89_g2153.g;
				float Ao_Output157_g2153 = ( pow( abs( AoMapBase103_g2153 ) , _AmbientOcclusionIntensity ) * ( 1.5 / ( ( saturate( TobyTranslucency66_g2153 ) * TranslucencyIntensity72_g2153 ) + 1.5 ) ) );
				
				float2 uv_AlbedoMap86_g2153 = input.ase_texcoord9.xy;
				float Opacity_Output155_g2153 = ( 1.0 - tex2D( _AlbedoMap, uv_AlbedoMap86_g2153 ).a );
				

				float3 BaseColor = Albedo_Output160_g2153.rgb;
				float3 Normal = Normal_Output154_g2153;
				float3 Emission = 0;
				float3 Specular = temp_cast_7;
				float Metallic = 0;
				float Smoothness = Smoothness_Output159_g2153;
				float Occlusion = Ao_Output157_g2153;
				float Alpha = 1;
				float AlphaClipThreshold = ( Opacity_Output155_g2153 * _AlphaClip );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_AlbedoMap86_g2153 = input.ase_texcoord3.xy;
				float Opacity_Output155_g2153 = ( 1.0 - tex2D( _AlbedoMap, uv_AlbedoMap86_g2153 ).a );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_AlbedoMap285_g2153 = input.ase_texcoord4.xy;
				float2 uv_AlbedoMap295_g2153 = input.ase_texcoord4.xy;
				float4 tex2DNode295_g2153 = tex2D( _AlbedoMap, uv_AlbedoMap295_g2153 );
				float2 uv_NoiseMapGrayscale302_g2153 = input.ase_texcoord4.xy;
				float4 transform307_g2153 = mul(GetObjectToWorldMatrix(),float4( 1,1,1,1 ));
				float dotResult4_g2155 = dot( transform307_g2153.xy , float2( 12.9898,78.233 ) );
				float lerpResult10_g2155 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g2155 ) * 43758.55 ) ));
				float3 normalizeResult259_g2153 = normalize( input.ase_texcoord5.xyz );
				float DryLeafPositionMask263_g2153 = ( (distance( normalizeResult259_g2153 , float3( 0,0.8,0 ) )*1.0 + 0.0) * 1 );
				float4 lerpResult294_g2153 = lerp( ( _DryLeafColor * ( tex2DNode295_g2153.g * 2 ) ) , tex2DNode295_g2153 , saturate( (( ( tex2D( _NoiseMapGrayscale, uv_NoiseMapGrayscale302_g2153 ).r * lerpResult10_g2155 * DryLeafPositionMask263_g2153 ) - _SeasonChangeGlobal )*_DryLeavesScale + _DryLeavesOffset) ));
				float4 SeasonControl_Output311_g2153 = lerpResult294_g2153;
				Gradient gradient271_g2153 = NewGradient( 0, 2, 2, float4( 1, 0.276868, 0, 0 ), float4( 0, 1, 0.7818019, 1 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				...
				float lerpResult10_g2154 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g2154 ) * 43758.55 ) ));
				float4 lerpResult282_g2153 = lerp( SeasonControl_Output311_g2153 , ( ( SeasonControl_Output311_g2153 * 0.5 ) + ( SampleGradient( gradient271_g2153, lerpResult10_g2154 ) * SeasonControl_Output311_g2153 ) ) , _ColorVariation);
				float2 uv_MaskMapRGBA313_g2153 = input.ase_texcoord4.xy;
				float4 lerpResult283_g2153 = lerp( tex2D( _AlbedoMap, uv_AlbedoMap285_g2153 ) , lerpResult282_g2153 , (( _BranchMaskR )?( tex2D( _MaskMapRGBA, uv_MaskMapRGBA313_g2153 ).r ):( 1.0 )));
				float4 GrassColorVariation_Output109_g2153 = lerpResult283_g2153;
				float3 ase_viewVectorWS = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				float3 ase_viewDirWS = normalize( ase_viewVectorWS );
				float4 transform39_g2153 = mul(GetObjectToWorldMatrix(),float4( input.ase_texcoord5.xyz , 0.0 ));
				float dotResult52_g2153 = dot( float4( ase_viewDirWS , 0.0 ) , -( float4( _MainLightPosition.xyz , 0.0 ) + ( (( _TranslucencyFluffiness )?( transform39_g2153 ):( float4( input.ase_texcoord5.xyz , 0.0 ) )) * _TranslucencyRange ) ) );
				float2 uv_MaskMapRGBA58_g2153 = input.ase_texcoord4.xy;
				float ase_lightIntensity = max( max( _MainLightColor.r, _MainLightColor.g ), _MainLightColor.b );
				float4 ase_lightColor = float4( _MainLightColor.rgb / ase_lightIntensity, ase_lightIntensity );
				float TobyTranslucency66_g2153 = ( saturate( dotResult52_g2153 ) * tex2D( _MaskMapRGBA, uv_MaskMapRGBA58_g2153 ).b * ase_lightColor.a );
				float TranslucencyIntensity72_g2153 = _TranslucencyPower;
				...
				float2 uv_AlbedoMap86_g2153 = input.ase_texcoord4.xy;
				float Opacity_Output155_g2153 = ( 1.0 - tex2D( _AlbedoMap, uv_AlbedoMap86_g2153 ).a );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_AlbedoMap285_g2153 = input.ase_texcoord2.xy;
				float2 uv_AlbedoMap295_g2153 = input.ase_texcoord2.xy;
				float4 tex2DNode295_g2153 = tex2D( _AlbedoMap, uv_AlbedoMap295_g2153 );
				float2 uv_NoiseMapGrayscale302_g2153 = input.ase_texcoord2.xy;
				float4 transform307_g2153 = mul(GetObjectToWorldMatrix(),float4( 1,1,1,1 ));
				float dotResult4_g2155 = dot( transform307_g2153.xy , float2( 12.9898,78.233 ) );
				float lerpResult10_g2155 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g2155 ) * 43758.55 ) ));
				float3 normalizeResult259_g2153 = normalize( input.ase_texcoord3.xyz );
				float DryLeafPositionMask263_g2153 = ( (distance( normalizeResult259_g2153 , float3( 0,0.8,0 ) )*1.0 + 0.0) * 1 );
				float4 lerpResult294_g2153 = lerp( ( _DryLeafColor * ( tex2DNode295_g2153.g * 2 ) ) , tex2DNode295_g2153 , saturate( (( ( tex2D( _NoiseMapGrayscale, uv_NoiseMapGrayscale302_g2153 ).r * lerpResult10_g2155 * DryLeafPositionMask263_g2153 ) - _SeasonChangeGlobal )*_DryLeavesScale + _DryLeavesOffset) ));
				float4 SeasonControl_Output311_g2153 = lerpResult294_g2153;
				Gradient gradient271_g2153 = NewGradient( 0, 2, 2, float4( 1, 0.276868, 0, 0 ), float4( 0, 1, 0.7818019, 1 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				...
				float lerpResult10_g2154 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g2154 ) * 43758.55 ) ));
				float4 lerpResult282_g2153 = lerp( SeasonControl_Output311_g2153 , ( ( SeasonControl_Output311_g2153 * 0.5 ) + ( SampleGradient( gradient271_g2153, lerpResult10_g2154 ) * SeasonControl_Output311_g2153 ) ) , _ColorVariation);
				float2 uv_MaskMapRGBA313_g2153 = input.ase_texcoord2.xy;
				float4 lerpResult283_g2153 = lerp( tex2D( _AlbedoMap, uv_AlbedoMap285_g2153 ) , lerpResult282_g2153 , (( _BranchMaskR )?( tex2D( _MaskMapRGBA, uv_MaskMapRGBA313_g2153 ).r ):( 1.0 )));
				float4 GrassColorVariation_Output109_g2153 = lerpResult283_g2153;
				float3 ase_viewVectorWS = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				float3 ase_viewDirWS = normalize( ase_viewVectorWS );
				float4 transform39_g2153 = mul(GetObjectToWorldMatrix(),float4( input.ase_texcoord3.xyz , 0.0 ));
				float dotResult52_g2153 = dot( float4( ase_viewDirWS , 0.0 ) , -( float4( _MainLightPosition.xyz , 0.0 ) + ( (( _TranslucencyFluffiness )?( transform39_g2153 ):( float4( input.ase_texcoord3.xyz , 0.0 ) )) * _TranslucencyRange ) ) );
				float2 uv_MaskMapRGBA58_g2153 = input.ase_texcoord2.xy;
				float ase_lightIntensity = max( max( _MainLightColor.r, _MainLightColor.g ), _MainLightColor.b );
				float4 ase_lightColor = float4( _MainLightColor.rgb / ase_lightIntensity, ase_lightIntensity );
				float TobyTranslucency66_g2153 = ( saturate( dotResult52_g2153 ) * tex2D( _MaskMapRGBA, uv_MaskMapRGBA58_g2153 ).b * ase_lightColor.a );
				float TranslucencyIntensity72_g2153 = _TranslucencyPower;
				...
				float2 uv_AlbedoMap86_g2153 = input.ase_texcoord2.xy;
				float Opacity_Output155_g2153 = ( 1.0 - tex2D( _AlbedoMap, uv_AlbedoMap86_g2153 ).a );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_NormalMap189_g2153 = input.ase_texcoord5.xy;
				float3 unpack189_g2153 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap189_g2153 ), _NormalIntensity );
				unpack189_g2153.z = lerp( 1, unpack189_g2153.z, saturate(_NormalIntensity) );
				float3 Normal_Output154_g2153 = unpack189_g2153;
				
				float2 uv_AlbedoMap86_g2153 = input.ase_texcoord5.xy;
				float Opacity_Output155_g2153 = ( 1.0 - tex2D( _AlbedoMap, uv_AlbedoMap86_g2153 ).a );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float2 uv_AlbedoMap86_g2153 = input.ase_texcoord.xy;
				float Opacity_Output155_g2153 = ( 1.0 - tex2D( _AlbedoMap, uv_AlbedoMap86_g2153 ).a );
				

				surfaceDescription.Alpha = 1;
				surfaceDescription.AlphaClipThreshold = ( Opacity_Output155_g2153 * _AlphaClip );
...
Node;AmplifyShaderEditor.FunctionNode;3977;-512,0;Inherit;False;(TTFE) Grass Foliage_Shading;1;;2153;c37c82b3855ad564a8be75e0d3f5f6bc;0;0;7;COLOR;0;FLOAT3;180;FLOAT;186;FLOAT;182;FLOAT;183;FLOAT;184;FLOAT3;188
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;3947;-160,304;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;3975;-528,256;Inherit;False;(TTFE) Grass Foliage_Wind System;27;;2152;587ec12ad6a469d48af93c852f23db70;0;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;3976;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
WireConnection;3947;0;3977;184
WireConnection;3947;1;3948;0
WireConnection;3932;0;3977;0
WireConnection;3932;1;3977;180
WireConnection;3932;9;3977;186
WireConnection;3932;4;3977;182
WireConnection;3932;5;3977;183
WireConnection;3932;7;3947;0
WireConnection;3932;8;3975;0
WireConnection;3932;10;3977;188
ASEEND*/
//CHKSM=B4267458ED2B04238475DADCF307236A20285A63